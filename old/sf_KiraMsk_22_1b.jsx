...
function main() 
{
    ...
    var compFinalName = "aeFinalKiraMskAll_b1";
    finalComp = handleFinalCompAll(compFinalName);
    
    var compFinalName = "aeFinalKiraMsk_b1";
    finalComp = handleFinalComp4(compFinalName);
    
    var compFinalName = "aeFinalKiraMskBaseBg_b1";
    finalComp = handleFinalCompBaseBg(compFinalName);
    
    var compFinalName = "aeFinalKiraMskBg_b1";
    finalComp = handleFinalCompBg(compFinalName);
    
    
    var compFinalName = "aeFinalKiraMskBase_b1";
    finalComp = handleFinalCompBase(compFinalName);
    
    
    var compFinalName = "aeFinalKiraMskBaseBi_b1";
